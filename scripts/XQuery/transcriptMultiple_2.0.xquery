...
:)
let $transcriptFile := $corpusTranscript//file 
(:
...
let $fileNameVersion := to:substring-before-match($tableImagedPapyri//FileName/text()[$posTM],'\.')
